    ...
    private void updateCustomer()
    {
        ...
        if(id != null) {
            ...
            try{
                ...
                if(customer != null)
                {
                    String phone = KeyboardUtil.getString("Please input the updated phone no: ");
                    customer.setPhone(phone);
                    service.updateCustomer(customer);
                }
            }catch (ServiceException e) {
                log.trace("Problem updating  customer with id no {}", id);
                log.trace(e.getMessage());
                System.out.println("Problem updating customer with id no: " + id);
                e.printStackTrace();
                return;
            }
    ...
    private void deleteCustById() {
        ...
        if(id != null) {
            try{
                ...
                log.trace("Problem deleting  customer with id no {}", id);
                log.trace(e.getMessage());
                System.out.println("Problem deleting customer with id no: " + id);
                e.printStackTrace();
                return;
            }
